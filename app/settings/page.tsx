            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <p className="text-sm font-medium">تم برنامه</p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold">سینما پلاس</h3>
                  <p className="text-sm text-muted-foreground">دانلود رایگان فیلم و سریال</p>
                </div>
                <div>
