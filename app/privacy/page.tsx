              ...
              >
                <div className="space-y-6">
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      'امکان پخش آنلاین محتوا با پلیر اختصاصی زینگو برای راحتی شما فراهم شده است.',
                ...
                <motion.div variants={item} className="space-y-6">
                  ...
                  <div className="space-y-4 text-base md:text-lg text-muted-foreground bg-gradient-to-br from-primary/10 to-primary/5 p-6 rounded-xl border border-primary/20 backdrop-blur-sm hover:shadow-lg hover:shadow-primary/5 transition-all duration-300">
                    ...
                    <p className="leading-relaxed">با امکاناتی مانند جستجوی پیشرفته، دسته‌بندی ژانرها، نمایش امتیازهای IMDB و پلیر اختصاصی با پشتیبانی از زیرنویس، تجربه تماشای فیلم و سریال را برای شما لذت‌بخش‌تر کرده‌ایم.</p>
